...
class HazelcastConfig {
  ...
  @Bean
  HazelcastQuorumListener membershipListener(
    @Value("${clustering.hazelcast.quorum:1}") final int quorum) {
  ...
  Config config(
    ...
    @Value("${clustering.hazelcast.members:127.0.0.1}") final String members)
